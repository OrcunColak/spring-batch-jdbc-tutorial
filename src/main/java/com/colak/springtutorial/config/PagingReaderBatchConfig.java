...
public class PagingReaderBatchConfig {

    private final DataSource dataSource;

    @Bean
    public Job job(JobRepository jobRepository, Step step) {
        return new JobBuilder("paging-job", jobRepository)
                .start(step)
                .build();
    }
    ...
    public Step step(
        ...
        return new StepBuilder("paging-step", jobRepository)
    ...
    public JdbcBatchItemWriter<Person> writer() {
        ...
        writer.setSql("INSERT INTO person_processed1 (id, name, age) VALUES (:id, :name, :age)");
